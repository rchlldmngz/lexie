$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Lexie turns 18.",

            // Event start date
            start: new Date('May 1, 2022 17:00'),

            // You can also choose to set an end time
            // If an end time is set, this will take precedence over duration
            end: new Date('May 1, 2022 21:00'),

            // Event Address
            address: 'Amira the Events Place, Bacoor, Cavite',
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $.post('https://script.google.com/macros/s/AKfycbwUUyMRiVAdcGwSH4CPf42IkmqwVDSP95PSgjCVWQW_dMYutrUOcT-JpKXNBcE8QgbI5g/exec', data)
            .done(function (data) {
                console.log(data);
